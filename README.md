...
Hello! I'm a software engineer with a passion for **programming languages**, **distributed systems**, and **artificial intelligence**. I specialize in C++, Python, and Go, with a keen interest in compiler development, microservices architecture, and reinforcement learning.

I am also a competitive AI researcher. I have achieved championships and top-tier rankings in national-level contests like **Tencent Kaiwu** and the **China Mobile AI Competition**. I'm always eager to learn and apply cutting-edge technologies to solve complex problems.

---

你好！我是一名软件工程师，热衷于**编程语言**、**分布式系统**和**人工智能**。我擅长 C++、Python 和 Go，对编译器开发、微服务架构和强化学习有着浓厚的兴趣。

同时，我也是一名活跃的 AI 竞赛选手，曾在**中国移动人工智能大赛**和**腾讯开悟**等国家级赛事中斩获冠军及多项前排荣誉。我热衷于学习并应用最前沿的技术来解决复杂的问题。

## 🏆 Honors & Awards / 荣誉奖项

| Year | Event / Competition <br> 赛事名称 | Achievement <br> 成绩/奖项 |
| :--- | :--- | :--- |
| **2025** | **China Mobile Artificial Intelligence Competition**<br>中国移动人工智能大赛 | 🥇 **Champion<br>冠军** |
| **2025** | **Tencent Kaiwu (Intermediate Track)**<br>腾讯开悟（中级赛道） | 🥉 **Third Place<br>季军** |
| **2025** | **Tencent Kaiwu (Advanced Track)**<br>腾讯开悟（高级赛道） | 🏅 **7th Place<br>第七名** |
| **2024** | **Tencent Kaiwu AIPC Track (Comprehensive)**<br>腾讯开悟 AIPC赛道（综合赛道） | 🥈 **Runner-up<br>亚军** |
| **2024** | **Tencent Kaiwu AIPC Track (Efficiency)**<br>腾讯开悟 AIPC赛道（效率赛道） | 🥉 **Third Place<br>季军** |
| **N/A**  | **National Scholarship**<br>国家奖学金 | 🎓 **Awarded Twice<br>两次获得** |

## 🚀 Technical Skills / 技术栈
